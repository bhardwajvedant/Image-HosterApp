...
public class ImageUploadController {
    ...
    public ResponseEntity<ImageEntity> imageupload(final ImageEntity imageUploadRequest, @RequestHeader("authorization") final String authorization) throws UploadFailedException, UnsupportedEncodingException {
